...
export class Message extends Model{
    ...
    getViewElement(me = true) {
        ...
        let qHora = Format.dateToTime(this.timeStamp.toDate());

        switch (this.type) {
            case 'contact':
                div.innerHTML = `
                    <div class="_3_7SH kNKwo tail">
                        <span class="tail-container" style="filter: saturate(0.8) brightness(0.86) hue-rotate(180deg) invert(1);"></span>
                        <span class="tail-container highlight" style="filter: saturate(0.8) brightness(0.86) hue-rotate(180deg) invert(1);"></span>
                            ...
                            <div class="_3DZ69" role="button">
                                ...
                                <div class="_3a5-b">
                                    <div class="_1DZAH" role="button">
                                        <span class="message-time">${qHora} </span>
                                    </div>
                                </div>
                            </div>
                            <div class="_6qEXM">
                        ...
                        <div class="KYpDv">
                            <div>
                                <div class="_3v3PK" style="width: 330px; height: 330px;">
                                    ...
                                    <div class="_1i3Za" style="background-image: linear-gradient(to top, rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0)) !important;"></div>
                                </div>
                                <div class="_2TvOE">
                    ...
                    <div class="_3_7SH _1ZPgd ">
                        <div class="_1fnMt _2CORf">
                            <a class="_1vKRe" href="#">
                                ...
                                <div class="_12xX7">
                                    <div class="_3eW69">
                                        <div class="JdzFp message-file-icon icon-doc-pdf" style="filter: saturate(0.8) brightness(0.86) hue-rotate(180deg) invert(1);"></div>
                                    </div>
                                    <div class="nxILt">
                            ...
                            <div class="_3cMIj">
                                ...
                                <span class="PyPig message-file-size">Size: ${this.size}</span>
                            </div>
                            <div class="_3Lj_s">
                                <div class="_1DZAH" role="button">
                                    <span class="message-time">${qHora} </span>
            ...
            case 'audio':
                            ...
                            <div class="_2jfIu">
                                ...
                                <div class="_2fuJy">
                                    <div class="_1WliW" style="height: 55px; width: 55px;">
                                        <img src="#" class="Qgzj8 gqwaM message-audio-photo" style="display:none">
                                        <div class="_3ZW2E">
                                            <span data-icon="default-user">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 212 212" width="212" height="212">
                                                    <path fill="#DFE5E7" d="M106.251.5C164.653.5 212 47.846 212 106.25S164.653 212 106.25 212C47.846 212 .5 164.654.5 106.25S47.846.5 106.251.5z"></path>
                ...
                `;
                console.log('Message 288', this.photo);
                if (this.photo) {
                    let img = div.querySelector('.message-audio-photo');
                    img.src = this.photo;
                    img.show();
                }
...
;
    ...
    static sendAudio(chatId, from, file, metadata, photo) {
        ...
        return Message.send(chatId, from, 'audio', '').then(msgRef =>{
            ...
            Message.upload(file, from).then(result => {

                result.ref.getDownloadURL().then(downloadFile => {
            ...
            Message.upload(file, from).then(result => {
                ...
                result.ref.getDownloadURL().then(downloadFile => {
                    ...
                    if (filePreview) {
                        ...
                        Message.upload(filePreview, from).then(result => {

                            result.ref.getDownloadURL().then(downloadPreview => {
                                msgRef.set({
                                    content: downloadFile,
