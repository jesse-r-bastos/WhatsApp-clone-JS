...
export class WhatsAppController {
    ...
    checkNotifications(){
        ...
        if (typeof Notification === 'function'){
            ...
            if (Notification.permission !== 'granted' ) {
                ...
                this.el.alertNotificationPermission.hide();this.el.alertNotificationPermission.hide();
    ...
    notification(data){
        ...
        console.log('WAC Not...:', Notification.permission);
    ...
    initContacts(){
        ...
        this._user.on('contactschange', docs => {
            ...
            docs.forEach( doc => {
                ...
                let qHora = Format.timeStampToTime(contact.lastMessageTime);

                console.log('initContacts' ,qHora);
                ...
                console.log('WAC 141: ', contact.photo);
                if (contact.photo) {
                ...
                div.on('click', e=>{
                    ...
                    this.el.panelMessagesContainer.scrollTop = 0;
    ...
    setActiveChat(contact){
        ...
        if (this._contactActive) {
            Message.getRef(this._contactActive.chatId).onSnapshot(()=> {}); // zerando o último Contato ativo
        };
        ...
        console.log('WAC 175: ', contact.photo);
        if (contact.photo) {
        ...
        this.el.panelMessagesContainer.innerHTML = ''; //Limpando Painel de mensagens
        ...
        Message.getRef(this._contactActive.chatId).orderBy('timeStamp')
                .onSnapshot(docs=>{
                    ...
                    docs.forEach(doc =>{
                        ...
                        console.log('WAC 268: me:', me, ' _msgRec: ', this._messagesReceived);

                        console.log('WAC 270:  _msgRec.len: ', this._messagesReceived.filter(id=> { return (id === data.id)}).length);

                        if (!me && this._messagesReceived.filter(id=> { return (id === data.id)}).length === 0 ) {

                            console.log('WAC 274:  Not..(data): ', data);
    ...
    elementsPrototype() {
        ...
        Element.prototype.haseClass = function (name) {
    ...
    initEvents() {
        ...
        this.el.inputProfilePhoto.on('change', e =>{
            ...
            if (this.el.inputProfilePhoto.files.length > 0 ) {
                ...
                Upload.send(file, this._user.emai).then((result) =>{

                    result.ref.getDownloadURL().then((snapshot) =>{
                        console.log('WAC 442: ', snapshot);
...
*/
            contact.on('datachange', data=>{
                ...
                if (data.name) {
                    ...
                    Chat.createIfNotExist(this._user.email, email).then(chat=>{
...
*/
            ...
            if (this.el.inputDocument.files.length) {
                ...
                this._documentPreviewController.getPreviewData().then(result=>{
                    ...
                    switch (file.type) {
                        ...
                        default:
                            this.el.iconPanelDocumentPreview.className = 'jcxhw aumenta icon-doc-generic';
                            break;
                    }
        ...
        this.el.btnSendDocument.on('click', e=>{
            ...
            let file = this.el.inputDocument.files[0];
            let fbase64 = this.el.imgPanelDocumentPreview.src;

            if (file.type === 'application/pdf') {

                Base64.toFile(fbase64).then(filePreview => {
        ...
        this.el.btnAttachContact.on('click', e => {
            ...
            this._contactsController.open(this._contactActive.email);
        ...
        this.el.panelEmojis.querySelectorAll('.emojik').forEach(emoji => {
            ...
            emoji.on('click', e => {
                ...
                img.dataset.unicodet = emoji.dataset.unicodet;
                img.alt = emoji.dataset.unicodet;
